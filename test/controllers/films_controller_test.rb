...
class FilmsControllerTest < ActionController::TestCase
  ...
  test "should create film" do
    assert_difference('Film.count') do
      post :create, film: { director: @film.director, note: @film.note, synopsis: @film.synopsis, title: @film.title }
    end
  ...
  test "should update film" do
    patch :update, id: @film, film: { director: @film.director, note: @film.note, synopsis: @film.synopsis, title: @film.title }
    assert_redirected_to film_path(assigns(:film))
  end
